const testData = {
    ...
    putInvalidIdFormat: { title: "Updated Activity", dueDate: "2024-10-01", completed: true },
    putCompletedAsIncorrectType: { title: "Updated Activity", dueDate: "2024-10-01", completed: "true" },
    putEmptyBody: {},
    specialCharId: '&%^@'
};
